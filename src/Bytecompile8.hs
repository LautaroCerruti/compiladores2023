...
runBC8 bc = runMacchina bc [] []

runMacchina :: MonadFD4 m => Bytecode8 -> Env -> [Val] -> m ()
runMacchina btc env stack = do 
                              addStep
                              checkMaxStack stack
                    ...
                    where 
                          ...
                          runMacchina' (FUNCTION : c) e s = addClousureCount >>= \_ -> runMacchina (drop ((bc2int (take 4 c)) + 4) c) e ((Fun e (drop 4 c)) : s)
